...
//        
        ...
        NSError * nsError = nil;
        [audioSession setCategory:AVAudioSessionCategoryPlayback error:&nsError];
        [audioSession setCategory:AVAudioSessionCategoryMultiRoute withOptions:AVAudioSessionCategoryOptionDefaultToSpeaker error:&nsError];
